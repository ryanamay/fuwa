    ...
    <>
      {isLoading ? (
        ...
        <main className="relative bg-white">
          ...
          <div className="z-0 flex flex-col min-h-screen pl-28 py-10 gap-8 items-start bg-[#FFE2E2] snap-center">
            <div className="z-0 flex flex-col gap-2 bg-grey-200 min-w-full">
              <h3 className="text-[#F38181] font-bold  text-4xl min-w-full ">
                {" "}
                about{" "}
              </h3>
            </div>
          ...
          <div className="z-0 flex flex-col min-h-screen pl-28 py-10 gap-8 items-start bg-[#8785A2] snap-center">
            <div className="z-0 flex flex-col gap-8 bg-grey-200 min-w-full">
              <h3 className="text-[#fff5e4] font-bold  text-4xl min-w-full ">
                {" "}
                contact{" "}
              </h3>
              <div className="flex flex-row gap-2">
              <div className="flex flex-col ">
                <div className="z-0 border-[#FFF5E4] border-t-8 border px-2 py-1 flex flex-col w-[300px] h-[420px] items-start">
